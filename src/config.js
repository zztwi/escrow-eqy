...
module.exports = {
  ...
  supportPanelChannelId: process.env.SUPPORT_PANEL_CHANNEL_ID || "1520296056145842186",
  supportCategoryId: process.env.SUPPORT_CATEGORY_ID || "1520299106751221801",
  ...
  boosterRewardRoleId: process.env.BOOSTER_REWARD_ROLE_ID || "1519311155221364896",
  boostLogChannelId: process.env.BOOST_LOG_CHANNEL_ID || process.env.WELCOME_CHANNEL_ID || "",
  boostRewardChannelId: process.env.BOOST_REWARD_CHANNEL_ID || process.env.INFO_CHANNEL_ID || "1518103260014317690",
  feePercent: numberEnv("FEE_PERCENT", 8),
  boosterFeePercent: numberEnv("BOOSTER_FEE_PERCENT", 6),
